...
module.exports = {
  up: (queryInterface, Sequelize) => {
     return queryInterface.bulkInsert('Products',
       Array.from({ length: 20 }, (val, index) => ({
         ...
         sale_date: index < 6 ? faker.date.between('2019-12-01', '2019-12-31') : faker.date.between('2019-02-01', '2019-02-31'),
         deadline: index < 11 ? faker.date.between('2019-11-01', '2019-11-31') : faker.date.between('2019-01-01', '2019-01-31'),
         Series_id: randomNum(1, 5),
         Category_id: randomNum(1, 5)
       }))
     )
  }, 
  ...
  // deadline:     1-10 在11月截止預約, 11-20 可預約至明年 1 月
  // sale_date:    1-5  在12月開始販售, 6-20 將在明年 2 月份銷售,
  //               6-10 等待販售(下架狀態)
